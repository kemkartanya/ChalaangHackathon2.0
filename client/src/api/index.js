...
export const newSignIn = async ({ email, password, name, preferredPlatforms, gameGenre, location, score }) => await API.post('/auth/signin', { email, password, name, preferredPlatforms, gameGenre, location, score }); 
