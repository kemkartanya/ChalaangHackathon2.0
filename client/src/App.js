...
import Streaming from '../src/pages/Streaming.jsx'
        ...
        <Podstream>
          ...
          <Frame>
            ...
            <Routes>
              ...
              <Route path='/streaming' exact element={<Streaming setSignInOpen={setSignInOpen}/>} />
              <Route path='/search' exact element={<Search />} />
              <Route path='/favourites' exact element={<Favourites />} />
              <Route path='/profile' exact element={<Profile />} />
              <Route path='/podcast/:id' exact element={<PodcastDetails />} />
              <Route path='/showpodcasts/:type' exact element={<DisplayPodcasts/>} />
              <Route path='/playgame' exact element={<MemoryGame/>} />
            </Routes>
          </Frame>
